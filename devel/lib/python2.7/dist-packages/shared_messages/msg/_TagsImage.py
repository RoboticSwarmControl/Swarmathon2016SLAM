...
"""autogenerated by genpy from shared_messages/TagsImage.msg. Do not edit."""
import sys
...
class TagsImage(genpy.Message):
  _md5sum = "b132e3eadc4e6e4beec609ce40f264d8"
  _type = "shared_messages/TagsImage"
...
"""
  ...
  _slot_types = ['std_msgs/UInt16MultiArray','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TagsImage, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.tags is None:
        self.tags = std_msgs.msg.UInt16MultiArray()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.tags.layout.dim)
      buff.write(_struct_I.pack(length))
      for val1 in self.tags.layout.dim:
        _x = val1.label
        length = len(_x)
      ...
      buff.write(_struct_I.pack(self.tags.layout.data_offset))
      length = len(self.tags.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.pack(pattern, *self.tags.data))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.tags.layout.dim.append(val1)
      start = end
      end += 4
      (self.tags.layout.data_offset,) = _struct_I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sH'%length
      ...
      self.tags.data = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(self.tags.data.tostring())
      _x = self
      buff.write(_struct_3I.pack(_x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
      _x = self.image.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.tags.data = numpy.frombuffer(str[start:end], dtype=numpy.uint16, count=length)
      _x = self
      start = end
      end += 12
      (_x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
