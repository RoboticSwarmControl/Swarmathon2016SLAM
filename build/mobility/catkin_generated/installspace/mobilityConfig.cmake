...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mobility' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/swarmie/rover_workspace/install/${idir}'.  Ask the maintainer 'NASA Swarmathon <swarmathon@cs.unm.edu>' to fix it.")
    endif()
