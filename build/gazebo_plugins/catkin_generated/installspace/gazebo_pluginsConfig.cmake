...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_plugins_SOURCE_PREFIX /home/swarmie/rover_workspace/src/gazebo_plugins)
  set(gazebo_plugins_DEVEL_PREFIX /home/swarmie/rover_workspace/devel)
  ...
  set(gazebo_plugins_INSTALL_PREFIX /home/swarmie/rover_workspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'matthew <matthew@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/swarmie/rover_workspace/install/${idir}'.  Ask the maintainer 'matthew <matthew@todo.todo>' to fix it.")
    endif()
...
set(gazebo_plugins_EXPORTED_TARGETS "")
